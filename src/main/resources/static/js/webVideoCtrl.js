	...
	if (!e.WebVideoCtrl) {
		var t = function() {
			...
			e.PluginEventHandler = function(e, t, s) {
				k("插件事件：PluginEventHandler iEventType：%s iParam1: %s, iParam2: %s", e, t, s),
				b == e || M == e ? f.I_Stop(t) : L == e ? f.I_StopRecord(t) : q == e && f.I_StopVoiceTalk(),
				a.cbEvent && a.cbEvent(e, t, s)
			},
			e.GetHttpInfo = function(e, t) {
				k("http响应返回：http状态：%s, http数据：%s", e, t),
				ee.prototype.processCallback(e, t)
			};
			var k = function() {
				if (a.bDebugMode) {
					var e = Z(arguments);
			...
			j = function(e) {
				e.oStreamCapa.bObtained || e.oProtocolInc instanceof te && (G == e.szDeviceType || X == e.szDeviceType || H == e.szDeviceType ? e.oProtocolInc.getStreamChannels(e, {
					async: !1,
					success: function(t) {
			...
			this.I_StartRealPlay = function(e, t) {
				...
				if (I.extend(h, t), -1 != n) {
					...
					var f = l[n];
					null == m && E();
					var C = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
					if (C == R && f.oStreamCapa.bSupportShttpPlay ? (k("SHTTP RealPlay"), o = f.oProtocolInc.CGI.startShttpRealPlay, i = "http://", d = h.iStreamType - 1, c = h.iChannelID <= f.iAnalogChannelNum ? h.iChannelID: f.oStreamCapa.iIpChanBase + parseInt(h.iChannelID, 10) - f.iAnalogChannelNum - 1, P = !0, W(h.iPort) ? "https://" == f.szHttpProtocol ? ( - 1 == f.iHttpPort && (f.iHttpPort = B(f).iHttpPort), a = f.iHttpPort) : a = f.iCGIPort: (f.iHttpPort = h.iPort, a = h.iPort)) : (k("RTSP RealPlay"), o = f.oProtocolInc.CGI.startRealPlay, i = "rtsp://", d = h.iStreamType, c = h.iChannelID, W(h.iPort) || (f.iRtspPort = h.iPort), -1 == f.iRtspPort && (f.iRtspPort = B(f).iRtspPort), a = f.iRtspPort), -1 == a) return k("获取端口号失败"),
					r;
					if (I.extend(h, {
						urlProtocol: i,
						cgi: o,
			...
			this.I_StartPlayback = function(e, t) {
				...
				if (I.extend(d, t), -1 != n) {
					...
					var P = l[n];
					null == m && E();
					var h = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
					if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = W(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback: P.oProtocolInc.CGI.startTransCodePlayback, i = "http://", c = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", c = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a) return k("获取端口号失败"),
					r;
					I.extend(d, {
						urlProtocol: i,
						cgi: o,
			...
			ee.prototype.m_httpRequestSet = [],
			ee.prototype.setRequestParam = function(e) {
				I.extend(this.options, e)
			},
			ee.prototype.submitRequest = function() {
			...
			ee.prototype.getHttpMethod = function(e) {
				var t = {
					GET: 1,
					POST: 2,
					PUT: 5,
			...
			ee.prototype.processCallback = function(e, t) {
				for (var s = null,
			...
			ee.prototype.httpDataAnalyse = function(e, t) {
				var s = "",
				n = 0;
			...
			te.prototype.login = function(e, t, n, r) {
				var o = 2 == r.protocol ? "https://": "http://",
				i = Z(this.CGI.login, o, e, t),
				a = new ee,
				c = {
					type: "GET",
					url: i,
			...
			te.prototype.getAudioInfo = function(e, t) {
				var s = Z(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getDeviceInfo = function(e, t) {
				var n = Z(this.CGI.getDeviceInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
				r = new ee,
				o = {
					type: "GET",
					url: n,
			...
			te.prototype.getAnalogChannelInfo = function(e, t) {
				var n = Z(this.CGI.getAnalogChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
				r = new ee,
				o = {
					type: "GET",
					url: n,
			...
			te.prototype.getDigitalChannel = function(e, t) {
				var n = Z(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort),
				r = new ee,
				o = {
					type: "GET",
					url: n,
			...
			te.prototype.getDigitalChannelInfo = function(e, t) {
				var n = null,
				r = {};
				if (this.getDigitalChannel(e, {
					...
					success: function(e) {
						...
						for (var t = s.$XML(n).find("InputProxyChannel", !0), o = 0, i = t.length; i > o; o++) {
							var a = t[o],
							c = s.$XML(a).find("id").eq(0).text(),
							u = s.$XML(a).find("name").eq(0).text();
							r[c] = u
						}
					},
					error: function(e, s) {
					...
					var o = Z(this.CGI.getDigitalChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
					i = new ee,
					a = {
						type: "GET",
						url: o,
					...
					I.extend(a, {
						success: function(e) {
							...
							for (var o = s.$XML(e).find("InputProxyChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
								var c = o[i],
								u = s.$XML(c).find("id").eq(0).text();
								n.push("<InputProxyChannelStatus>"),
								n.push("<id>" + u + "</id>"),
								n.push("<sourceInputPortDescriptor>"),
								n.push("<proxyProtocol>" + s.$XML(c).find("proxyProtocol").eq(0).text() + "</proxyProtocol>"),
								n.push("<addressingFormatType>" + s.$XML(c).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
								n.push("<ipAddress>" + s.$XML(c).find("ipAddress").eq(0).text() + "</ipAddress>"),
								n.push("<managePortNo>" + s.$XML(c).find("managePortNo").eq(0).text() + "</managePortNo>"),
								n.push("<srcInputPort>" + s.$XML(c).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
								n.push("<userName>" + I.escape(s.$XML(c).find("userName").eq(0).text()) + "</userName>"),
								n.push("<streamType>" + s.$XML(c).find("streamType").eq(0).text() + "</streamType>"),
								n.push("<online>" + s.$XML(c).find("online").eq(0).text() + "</online>"),
								n.push("<name>" + I.escape(r[u]) + "</name>"),
								n.push("</sourceInputPortDescriptor>"),
								n.push("</InputProxyChannelStatus>")
							}
							n.push("</InputProxyChannelStatusList>"),
			...
			te.prototype.getZeroChannelInfo = function(e, t) {
				var s = Z(this.CGI.getZeroChannelInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getStreamChannels = function(e, t) {
				if (0 != e.iAnalogChannelNum) var s = Z(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
				else var s = Z(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
				var n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getStreamDynChannels = function(e, t) {
				var s = Z(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getPPPoEStatus = function(e, t) {
				var s = Z(this.CGI.getPPPoEStatus, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getUPnPPortStatus = function(e, t) {
				var s = Z(this.CGI.getUPnPPortStatus, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getNetworkBond = function(e, t) {
				var s = Z(this.CGI.getNetworkBond, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getNetworkInterface = function(e, t) {
				var s = Z(this.CGI.getNetworkInterface, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			te.prototype.getPortInfo = function(e, t) {
				var n = Z(this.CGI.getPortInfo, e.szHttpProtocol, e.szIP, e.iCGIPort),
				r = new ee,
				o = {
					type: "GET",
					url: n,
				...
				I.extend(o, {
					success: function(n) {
						var r = s.$XML(n).find("AdminAccessProtocol", !0),
						o = !1,
						i = [];
						i.push("<AdminAccessProtocolList>");
						for (var a = 0,
						c = r.length; c > a; a++) {
							var u = r[a];
							i.push("<AdminAccessProtocol>"),
							i.push("<id>" + s.$XML(n).find("id").eq(0).text() + "</id>"),
							i.push("<enabled>" + s.$XML(n).find("enabled").eq(0).text() + "</enabled>"),
							i.push("<protocol>" + s.$XML(n).find("protocol").eq(0).text().toUpperCase() + "</protocol>"),
							i.push("<portNo>" + s.$XML(n).find("portNo").eq(0).text() + "</portNo>"),
							i.push("</AdminAccessProtocol>"),
							"RTSP" == s.$XML(u).find("protocol").eq(0).text() && (o = !0)
						}
						o ? t.success && t.success(n) : P.getStreamChannels(e, {
							async: !1,
							success: function(n) {
								if (s.$XML(n).find("rtspPortNo", !0).length > 0) {
									var r = parseInt(s.$XML(n).find("rtspPortNo").eq(0).text(), 10);
									i.push("<AdminAccessProtocol>"),
									i.push("<id>4</id>"),
									i.push("<enabled>true</enabled>"),
									i.push("<protocol>RTSP</protocol>"),
									i.push("<portNo>" + r + "</portNo>"),
									i.push("</AdminAccessProtocol>"),
									i.push("</AdminAccessProtocolList>");
									var o = I.loadXML(i.join(""));
									t.success && t.success(o)
								} else P.getStreamDynChannels(e, {
									async: !1,
									success: function(e) {
										if (s.$XML(e).find("rtspPortNo", !0).length > 0) {
											...
											i.push("<enabled>true</enabled>"),
											i.push("<protocol>RTSP</protocol>"),
											i.push("<portNo>" + n + "</portNo>"),
											i.push("</AdminAccessProtocol>"),
											i.push("</AdminAccessProtocolList>");
											var r = I.loadXML(i.join(""));
			...
			te.prototype.startRealPlay = function(e, t) {
				var s = 100 * t.iChannelID + t.iStreamType,
				n = "";
				n = t.bZeroChannel ? Z(t.cgi.zeroChannels, t.urlProtocol, e.szIP, t.iPort, s) : Z(t.cgi.channels, t.urlProtocol, e.szIP, t.iPort, s);
			...
			te.prototype.startVoiceTalk = function(e, t) {
				var s = Z(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
				n = Z(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
				r = Z(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
				o = c.HWP_StartVoiceTalk(s, n, r, e.szAuth, e.iAudioType);
				return o
			},
			te.prototype.ptzAutoControl = function(e, t, s, n) {
				var r = s.iChannelID,
				o = "",
				i = "";
				if (n.iPTZSpeed = n.iPTZSpeed < 7 ? 15 * n.iPTZSpeed: 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X) o = r <= e.iAnalogChannelNum ? Z(this.CGI.ptzAutoControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : s.bShttpIPChannel ? Z(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : Z(this.CGI.ptzAutoControl.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID),
				i = "<?xml version='1.0' encoding='UTF-8'?><autoPanData><autoPan>" + n.iPTZSpeed + "</autoPan></autoPanData>";
				else {
					var a = 99;
					t && (a = 96),
					o = Z(this.CGI.ptzAutoControl.ipdome, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID, a)
				}
				var c = new ee,
				u = {
					type: "PUT",
				...
				I.extend(u, {
					...
					error: function(t, r) {
						if (G == e.szDeviceType || H == e.szDeviceType) {
							o = s.bShttpIPChannel ? Z(l.CGI.ptzControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : Z(l.CGI.ptzControl.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID),
			...
			te.prototype.ptzControl = function(e, t, s, n) {
				var r = s.iChannelID,
				o = "";
				...
				o = c != this.CGI.ptzFocus && c != this.CGI.ptzIris || e.szDeviceType != G && e.szDeviceType != X && e.szDeviceType != H ? r <= e.iAnalogChannelNum ? Z(c.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : s.bShttpIPChannel ? Z(c.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : Z(c.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID) : Z(c.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID);
				var u = new ee,
				l = {
					type: "PUT",
					url: o,
			...
			te.prototype.setPreset = function(e, t, s) {
				var n = t.iChannelID,
				r = "",
				o = "";
				r = n <= e.iAnalogChannelNum ? Z(this.CGI.setPreset.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID) : t.bShttpIPChannel ? Z(this.CGI.setPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum, s.iPresetID) : Z(this.CGI.setPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID),
			...
			te.prototype.goPreset = function(e, t, s) {
				var n = t.iChannelID,
				r = "";
				r = n <= e.iAnalogChannelNum ? Z(this.CGI.goPreset.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID) : t.bShttpIPChannel ? Z(this.CGI.goPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum, s.iPresetID) : Z(this.CGI.goPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID);
				var o = new ee,
				i = {
					type: "PUT",
					url: r,
			...
			te.prototype.recordSearch = function(e, n) {
				var r = "",
				o = "",
				i = n.iChannelID,
				a = n.szStartTime.replace(" ", "T") + "Z",
				c = n.szEndTime.replace(" ", "T") + "Z";
				r = Z(this.CGI.recordSearch, e.szHttpProtocol, e.szIP, e.iCGIPort),
			...
			te.prototype.startPlayback = function(e, t) {
				var s = t.iWndIndex,
				n = t.szStartTime,
				r = t.szEndTime,
				o = Z(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r);
			...
			te.prototype.reversePlayback = function(e, t) {
				var s = t.iWndIndex,
				n = t.szStartTime,
				r = t.szEndTime,
				o = Z(t.cgi, t.urlProtocol, e.szIP, t.iPort, t.iChannelID, n, r),
			...
			te.prototype.startDownloadRecord = function(e, t) {
				var s = Z(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort),
			...
			te.prototype.exportDeviceConfig = function(e) {
				var t = Z(this.CGI.deviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
				return c.HWP_ExportDeviceConfig(t, e.szAuth, "", 0)
			},
			te.prototype.importDeviceConfig = function(e, t) {
				var s = Z(this.CGI.deviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
				return c.HWP_ImportDeviceConfig(s, e.szAuth, t.szFileName, 0)
			},
			te.prototype.restart = function(e, t) {
				var s = Z(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "PUT",
					url: s,
			...
			te.prototype.restore = function(e, t, s) {
				var n = Z(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
				r = new ee,
				o = {
					type: "PUT",
					url: n,
			...
			te.prototype.startUpgrade = function(e, t) {
				var s = Z(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = Z(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
				return c.HWP_StartUpgrade(s, n, e.szAuth, t.szFileName)
			},
			te.prototype.set3DZoom = function(e, t, n, r) {
				var o = t.iChannelID,
				i = "";
				i = o <= e.iAnalogChannelNum ? Z(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID) : t.bShttpIPChannel ? Z(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID - e.oStreamCapa.iIpChanBase + 1 + e.iAnalogChannelNum) : Z(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID);
				var a = I.loadXML(n),
			...
			te.prototype.getSDKCapa = function(e, t) {
				var s = Z(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
					url: s,
					...
					I.extend(a, {
						success: function(e) {
							...
							for (var o = s.$XML(e).find("DynVideoInputChannelStatus", !0), i = 0, a = o.length; a > i; i++) {
								...
								n.push("<id>" + u + "</id>"),
								n.push("<sourceInputPortDescriptor>"),
								n.push("<proxyProtocol>" + s.$XML(c).find("adminProtocol").eq(0).text() + "</proxyProtocol>"),
								n.push("<addressingFormatType>" + s.$XML(c).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"),
								n.push("<ipAddress>" + s.$XML(c).find("ipAddress").eq(0).text() + "</ipAddress>"),
								n.push("<managePortNo>" + s.$XML(c).find("adminPortNo").eq(0).text() + "</managePortNo>"),
								n.push("<srcInputPort>" + s.$XML(c).find("srcInputPort").eq(0).text() + "</srcInputPort>"),
								n.push("<userName>" + I.escape(s.$XML(c).find("userName").eq(0).text()) + "</userName>"),
								n.push("<streamType>" + s.$XML(c).find("streamType").eq(0).text() + "</streamType>"),
								n.push("<online>" + s.$XML(c).find("online").eq(0).text() + "</online>"),
			...
			se.prototype.getStreamChannels = function(e, t) {
				if (0 != e.iAnalogChannelNum) var s = Z(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
				else var s = Z(this.CGI.getStreamChannels.digital, e.szHttpProtocol, e.szIP, e.iCGIPort);
				var n = new ee,
				r = {
					type: "GET",
					url: s,
			...
			se.prototype.getStreamDynChannels = function(e, t) {
				var s = Z(this.CGI.getStreamDynChannels, e.szHttpProtocol, e.szIP, e.iCGIPort),
				n = new ee,
				r = {
					type: "GET",
			...
			se.prototype.ptzAutoControl = function(e, t, s, n) {
				...
				o = "",
				i = "";
				if (n.iPTZSpeed = n.iPTZSpeed < 7 ? 15 * n.iPTZSpeed: 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X) o = Z(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, r),
				i = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + n.iPTZSpeed + "</pan><tilt>0</tilt></PTZData>";
				else {
					var a = 99;
					t && (a = 96),
					o = Z(this.CGI.goPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, r, a)
				}
				var c = new ee,
				u = {
					type: "PUT",
				...
				I.extend(u, {
					...
					error: function(t, r) {
						if (e.szDeviceType != X) {
							o = Z(l.CGI.ptzControl, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID);
							var a = new ee,
							c = {
								type: "PUT",
								url: o,
			...
			se.prototype.ptzControl = function(e, t, s, n) {
				...
				r = Z(a, e.szHttpProtocol, e.szIP, e.iCGIPort, s.iChannelID);
				var c = new ee,
				u = {
					type: "PUT",
					url: r,
			...
			se.prototype.setPreset = function(e, t, s) {
				var n = (t.iChannelID, ""),
				r = "";
				n = Z(this.CGI.setPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID),
			...
			se.prototype.goPreset = function(e, t, s) {
				var n = (t.iChannelID, "");
				n = Z(this.CGI.goPreset, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, s.iPresetID);
				var r = new ee,
				o = {
					type: "PUT",
					url: n,
			...
			se.prototype.set3DZoom = function(e, t, s, n) {
				var r = Z(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID),
				o = new ee,
				i = {
					type: "PUT",
					url: r,
			...
			var ne = function() {};
			ne.prototype._alert = function(e) {
			...
			re.prototype.loadXML = function(t) {
				...
				try {
					...
					if (t = '<?xml version="1.0" encoding="UTF-8"?><MockRoot></MockRoot>', e.DOMParser) {
						var n = new DOMParser;
						s = n.parseFromString(t, "text/xml")
					} else s = new ActiveXObject("Microsoft.XMLDOM"),
					s.async = !1,
			...
			re.prototype.toXMLStr = function(e) {
				var t = "";
				try {
			...
			re.prototype.escape = function(e) {
				return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
			},
			re.prototype.dateFormat = function(e, t) {
				var s = {
					"M+": e.getMonth() + 1,
					"d+": e.getDate(),
					"h+": e.getHours(),
			...
			re.prototype.Base64 = {
				...
				encode: function(e) {
					var t, s, n, r, o, i, a, c = "",
					u = 0;
					for (e = re.prototype.Base64._utf8_encode(e); u < e.length;) t = e.charCodeAt(u++),
					s = e.charCodeAt(u++),
					n = e.charCodeAt(u++),
					r = t >> 2,
					o = (3 & t) << 4 | s >> 4,
				...
				decode: function(e) {
					...
					return c = re.prototype.Base64._utf8_decode(c)
				},
			...
			d = new ne,
			I = new re;
			var oe = I.dateFormat(new Date, "yyyyMMddhhmmss");
			if (o = "webVideoCtrl" + oe, i = "webVideoCtrl" + oe, "object" != typeof e.attachEvent && I.browser().msie) {
				var ie = "<script for=" + o + " event='GetSelectWndInfo(SelectWndInfo)'>GetSelectWndInfo(SelectWndInfo);</script>";
				ie += "<script for=" + o + " event='ZoomInfoCallback(szZoomInfo)'>ZoomInfoCallback(szZoomInfo);</script>",
				ie += "<script for=" + o + "  event='GetHttpInfo(lID, lpInfo, lReverse)'>GetHttpInfo(lID, lpInfo, lReverse);</script>",
				ie += "<script for=" + o + "  event='PluginEventHandler(iEventType, iParam1, iParam2)'>PluginEventHandler(iEventType, iParam1, iParam2);</script>",
				document.write(ie)
			}
			return this
		} (),
