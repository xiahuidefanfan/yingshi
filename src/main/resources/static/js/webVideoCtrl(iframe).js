    ...
    if (!e.WebVideoCtrl) {
        var t = function() {
            ...
            e.GetHttpInfo = function(e, t) {
                ...
                tt.prototype.processCallback(e, t)
            };
            var Z = function() {
                if (a.bDebugMode) {
                    var e = k(arguments);
            ...
            F = function(e) {
                ...
                n = r.iDevicePort;
                    ...
                    for (var o = O(e), i = !1, a = 0; o.length > a; a++) if (o[a].ipv4 == e.szIP || o[a].ipv6 == e.szIP) {
                        i = !0;
                        break
                    }
                    i ? r = U(e) : (r = V(e), -1 == r.iRtspPort && -1 == r.iDevicePort && (r = U(e))),
                    t = r.iRtspPort,
                    s = r.iHttpPort,
                    n = r.iDevicePort
                }
            ...
            U = function(e) {
                ...
                return e.oProtocolInc.getPortInfo(e, {
                    ...
                    success: function(e) {
                        ...
                        t = 554;
                        for (var i = 0,
                        a = o.length; a > i; i++)"rtsp" === s.$XML(o).eq(i).find("protocol").eq(0).text().toLowerCase() && (t = parseInt(s.$XML(o).eq(i).find("portNo").eq(0).text(), 10)),
            ...
            K = function(e) {
                e.oStreamCapa.bObtained || e.oProtocolInc instanceof st && (G == e.szDeviceType || X == e.szDeviceType || H == e.szDeviceType ? e.oProtocolInc.getStreamChannels(e, {
                    async: !1,
                    success: function(t) {
            ...
            this.I_StartPlayback = function(e, t) {
                ...
                if (I.extend(d, t), -1 != n) {
                    ...
                    if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = W(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback: P.oProtocolInc.CGI.startTransCodePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = F(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = F(P).iRtspPort), a = P.iRtspPort), -1 == a) return Z("获取端口号失败"),
                    r;
                    I.extend(d, {
                        urlProtocol: i,
                        cgi: o,
            ...
            this.I_ReversePlayback = function(e, t) {
                ...
                if (I.extend(d, t), -1 != n) {
                    ...
                    var P = l[n],
                    h = parseInt(s.$XML(m).find("ProtocolType").eq(0).text(), 10);
                    if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = P.oProtocolInc.CGI.startShttpReversePlayback, i = "http://", u = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = F(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", u = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = F(P).iRtspPort), a = P.iRtspPort), -1 == a) return Z("获取端口号失败"),
                    r;
                    I.extend(d, {
                        urlProtocol: i,
                        cgi: o,
            ...
            this.I_CheckPluginInstall = function() {
                ...
                if (t.msie) try {
                    ...
                    e = 0
                } catch(s) {} else for (var n = 0,
                r = navigator.mimeTypes.length; r > n; n++) if ("application/webvideo-plugin-kit" == navigator.mimeTypes[n].type.toLowerCase()) {
                    e = 0;
                    break
                }
                return e
            ...
            tt.prototype.m_httpRequestSet = [],
            tt.prototype.setRequestParam = function(e) {
                I.extend(this.options, e)
            },
            tt.prototype.submitRequest = function() {
            ...
            tt.prototype.getHttpMethod = function(e) {
                var t = {
                    GET: 1,
                    POST: 2,
                    PUT: 5,
            ...
            tt.prototype.processCallback = function(e, t) {
                for (var s = null,
            ...
            tt.prototype.httpDataAnalyse = function(e, t) {
                var s = "",
                n = 0;
            ...
            st.prototype.set3DZoom = function(e, t, n, r) {
                var o = t.iChannelID,
                i = "";
            ...
            st.prototype.getSDKCapa = function(e, t) {
            ...
            nt.prototype.set3DZoom = function(e, t, s, n) {
            ...
            var rt = function() {};
            rt.prototype._alert = function(e) {
            ...
            ot.prototype.Base64 = {
                ...
                encode: function(e) {
                    var t, s, n, r, o, i, a, u = "",
                    c = 0;
                    for (e = ot.prototype.Base64._utf8_encode(e); e.length > c;) t = e.charCodeAt(c++),
                    s = e.charCodeAt(c++),
                    n = e.charCodeAt(c++),
                    r = t >> 2,
                    o = (3 & t) << 4 | s >> 4,
                ...
                decode: function(e) {
                    ...
                    return u = ot.prototype.Base64._utf8_decode(u)
                },
            ...
            d = new rt,
            I = new ot;
            var it = I.dateFormat(new Date, "yyyyMMddhhmmss");
            if (o = "webVideoCtrl" + it, i = "webVideoCtrl" + it, "object" != typeof e.attachEvent && I.browser().msie) {
                var at = "<script for=" + o + " event='GetSelectWndInfo(SelectWndInfo)'>GetSelectWndInfo(SelectWndInfo);</script>";
                at += "<script for=" + o + " event='ZoomInfoCallback(szZoomInfo)'>ZoomInfoCallback(szZoomInfo);</script>",
                at += "<script for=" + o + "  event='GetHttpInfo(lID, lpInfo, lReverse)'>GetHttpInfo(lID, lpInfo, lReverse);</script>",
                at += "<script for=" + o + "  event='PluginEventHandler(iEventType, iParam1, iParam2)'>PluginEventHandler(iEventType, iParam1, iParam2);</script>",
                document.write(at)
            }
            return this
        } (),
