...
public class AccessTokenApi {
	...
	public static final String APP_KEY = "95d47096703347e39b79017d88a1f1d7";
	public static final String SECRET = "5cdb8996f5cd7f82155c729ae00982cb";
	 ...
	 */
	public static HKAccessTokenDto getToken() {
    	...
    	if(CommonConstant.SUCCESS.equals(result.getString("code"))) {
    		return JSONObject.parseObject(result.getString("data"), HKAccessTokenDto.class);
    	}else {
