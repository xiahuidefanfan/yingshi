...
import com.hx.hkTest.hk.util.api.account.HKAccountApi;
import com.hx.hkTest.hk.util.api.device.HKDeviceConfigApi;
import com.hx.hkTest.hk.util.api.device.HKDeviceManageApi;
import com.hx.hkTest.hk.util.api.device.HKDeviceSelectApi;
...
public class ApiUtil {
	 ...
	 */
	public static HKAccessTokenDto getAccessToken() {
	...
	public static boolean deviceAdd(String deviceSerial, String validateCode) {
		return HKDeviceManageApi.deviceAdd(deviceSerial, validateCode);
	}
	...
	public static boolean deviceDelete(String deviceSerial) {
		return HKDeviceManageApi.deviceDelete(deviceSerial);
	}
	...
	public static boolean deviceCapture(String deviceSerial, String channelNo) {
		return HKDeviceManageApi.deviceCapture(deviceSerial, channelNo);
	}
	...
	public static boolean deviceIpcAdd(String deviceSerial, String ipcSerial, String channelNo, String validateCode) {
		return HKDeviceManageApi.deviceIpcAdd(deviceSerial, ipcSerial, channelNo, validateCode);
	}
	...
	public static boolean deviceIpcDelete(String deviceSerial, String ipcSerial, String channelNo) {
		return HKDeviceManageApi.deviceIpcDelete(deviceSerial, ipcSerial, channelNo);
	}
	...
	public static boolean devicePasswordUpdate(String deviceSerial, String oldPassword, String newPassword) {
		return HKDeviceManageApi.devicePasswordUpdate(deviceSerial, oldPassword, newPassword);
	}
	...
	public static String deviceWifiQrcode(String ssid, String password) {
		return HKDeviceManageApi.deviceWifiQrcode(ssid, password);
	}
	...
	public static boolean cameraNameUpdate(String deviceSerial, String name, String channelNo) {
		return HKDeviceManageApi.cameraNameUpdate(deviceSerial, name, channelNo);
	}
	...
	public static List<DeviceListDto> deviceList(String pageStart, String pageSize) {
		return HKDeviceSelectApi.deviceList(pageStart, pageSize);
	}
	...
	public static DeviceInfoDto deviceInfo(String deviceSerial){
		return HKDeviceSelectApi.deviceInfo(deviceSerial);
	}
	...
	public static List<CameraListDto> cameraList(String pageStart, String pageSize) {
		return HKDeviceSelectApi.cameraList(pageStart, pageSize);
	}
	...
	public static StatusGetDto statusGet(String deviceSerial, String channel) {
		return HKDeviceSelectApi.statusGet(deviceSerial, channel);
	}
	...
	public static DeviceCameraListDto deviceCameraList(String deviceSerial) {
		return HKDeviceSelectApi.deviceCameraList(deviceSerial);
	}
	...
	public static List<DeviceSupportEzvizDto> deviceSupportEzviz(String appKey, String model, String version) {
		return HKDeviceSelectApi.deviceSupportEzviz(appKey, model, version);
	}
	...
	public static DeviceCapacityDto deviceCapacity(String deviceSerial) {
		return HKDeviceSelectApi.deviceCapacity(deviceSerial);
	}
	...
	public static List<VideoByTimeDto> videoByTime(String deviceSerial, String channelNo, String startTime,
		...
		return HKDeviceSelectApi.videoByTime(deviceSerial, channelNo, startTime, endTime, recType);
	}
	...
	public static boolean deviceDefenceSet(String deviceSerial, String isDefence) {
		return HKDeviceConfigApi.deviceDefenceSet(deviceSerial, isDefence);
	}
	...
	public static boolean deviceEncryptOff(String deviceSerial, String validateCode) {
		return HKDeviceConfigApi.deviceEncryptOff(deviceSerial, validateCode);
	}
	...
	public static boolean deviceEncryptOff(String deviceSerial) {
		return HKDeviceConfigApi.deviceEncryptOn(deviceSerial);
	}
	...
	public static boolean deviceSoundSwitchStatus(String deviceSerial) {
		return HKDeviceConfigApi.deviceSoundSwitchStatus(deviceSerial);
	}
	...
	public static boolean deviceSoundSwitchSet(String deviceSerial, String enable, String channelNo) {
		return HKDeviceConfigApi.deviceSoundSwitchSet(deviceSerial, enable, channelNo);
	}
	...
	public static boolean deviceSceneSwitchStatus(String deviceSerial) {
		return HKDeviceConfigApi.deviceSceneSwitchStatus(deviceSerial);
	}
	...
	public static boolean deviceSceneSwitchSet(String deviceSerial, String enable, String channelNo) {
		return HKDeviceConfigApi.deviceSceneSwitchSet(deviceSerial, enable, channelNo);
	}
	...
	public static String ramAccountCreate(String accountName, String password) {
		return HKAccountApi.ramAccountCreate(accountName, password);
	}
