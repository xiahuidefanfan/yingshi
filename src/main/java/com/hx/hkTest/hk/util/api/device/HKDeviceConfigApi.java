...
/**
 * @ClassName: HKDeviceConfigApi.java
 * 功能描述：  序号	接口功能	                                   描述
 ...
 */
public class HKDeviceConfigApi {
	...
	public static boolean deviceEncryptOff(String deviceSerial, String validateCode) {
    	...
    	if(CommonConstant.SUCCESS.equals(code) || ErrorCodeEnum.YINGSHI_60016.getCode().equals(code)) {
    		return true;
    	}else {
    		throw new BusinsessException(ErrorCodeEnum.getEnum(result.getString("code")));
    	}
	...
	public static boolean deviceEncryptOn(String deviceSerial) {
    	...
    	String code = result.getString("code");
    	if(CommonConstant.SUCCESS.equals(code) || ErrorCodeEnum.YINGSHI_60019.getCode().equals(code)) {
    		return true;
    	}else {
    		throw new BusinsessException(ErrorCodeEnum.getEnum(result.getString("code")));
    	}
	...
	public static boolean deviceSoundSwitchSet(String deviceSerial, String enable, String channelNo) {
    	...
    	String code = result.getString("code");
    	if(CommonConstant.SUCCESS.equals(code) || ErrorCodeEnum.YINGSHI_60022.getCode().equals(code)) {
    		return true;
    	}else {
    		throw new BusinsessException(ErrorCodeEnum.getEnum(result.getString("code")));
    	}
